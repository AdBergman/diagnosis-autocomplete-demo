...
- Keep diagnosis and clinic adapters on the shared generic `AsyncAutocomplete<T, Cursor>` component. Domain-specific API, labels, rendering, and selected-value display belong in the thin adapters.
